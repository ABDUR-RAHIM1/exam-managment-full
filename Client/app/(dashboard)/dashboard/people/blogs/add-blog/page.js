...
import { adminCreatePutBlog } from "@/app/constans/constans";
...
export default function AddBlog() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isUpdateBlog) {
                ...
                const putApi = adminCreatePutBlog + manageData._id;
                ({ status, result } = await postDataHandler(formData, "PUT", putApi));
            } else {
                const postApi = adminCreatePutBlog;
    ...
    return (
        <form onSubmit={handleSubmit} className="mb-4 px-5 md:px-10" >
