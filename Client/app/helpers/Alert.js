...
export default function Alert({ handleCloseAlert }) {
    return (
        <div className=' px-4 w-full py-16  bg-opacity-0 absolute top-0 left-[50%] translate-x-[-50%] z-50'>

            <div className=' w-full md:w-[50%] m-auto  md:py-5 p-2 md:px-4 rounded-md border border-red-500 bg-red-100 text-red-500 text-center'>
                <div className=''>
